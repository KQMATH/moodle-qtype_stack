...
$settings->add(new admin_setting_configselect('qtype_stack/editorvisualmath',
        get_string('settingeditorvisualmath', 'qtype_stack'),
        get_string('settingeditorvisualmath_desc', 'qtype_stack'), '1',
